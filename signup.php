            ...
            <section class="register-photo">
                <div class="form-container">
                    ...
                    <form method="post" action="includes/signup.inc.php">
                        ...
                        ?>
                        <div class="mb-3"><button class="btn btn-primary d-block w-100" id="signup" type="submit" name="signup" style="margin-top: 0px;">Sign Up</button></div><a class="already" href="login.php">You already have an account? Login here.</a>
                    </form>
                </div>
            </section>
        <!-- </section> --> 
